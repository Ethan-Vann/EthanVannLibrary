    ...
    public String[] getActions() {
        ...
        switch (client.getVarbitValue(6590)) {
            ...
            case 2:
                ...
                break;
            case 3:
                actions[0] = "Withdraw-" + client.getVarbitValue(3960);
                break;
            case 4:
        ...
        //4
        if (client.getVarbitValue(3960) > 0) {
            actions[4] = "Withdraw-" + client.getVarbitValue(3960);
        }
        ...
        //8
        if (client.getVarbitValue(3755) == 0) {
