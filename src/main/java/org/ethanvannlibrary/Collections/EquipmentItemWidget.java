...
public class EquipmentItemWidget implements Widget {
    ...
    public void interact(PacketReflection packetReflection, String... actions) {
        packetReflection.mousePackets.queueClickPacket();
        packetReflection.widgetPackets.queueWidgetAction(RuneLite.getInjector().getInstance(Client.class).getWidget(packedId), actions);
    }
