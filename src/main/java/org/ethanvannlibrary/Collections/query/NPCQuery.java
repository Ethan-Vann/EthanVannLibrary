...
import org.ethanvannlibrary.Collections.Players;
import org.ethanvannlibrary.Utility.LocationUtilities;
...
public class NPCQuery {
    ...
    public NPCQuery walkable() {
        npcs = npcs.stream().filter(npc -> LocationUtilities.canPathToTile(npc.getWorldLocation()).isReachable()).collect(Collectors.toList());
        return this;
    }
